    ...
    */
    ...
    #define GAME_DEF_ACTION_PLAYER_INCREMENT 6
    #define GAME_DEF_ACTION_PLAYER_LOCKED 7
    #define GAME_DEF_ACTION_MOVE_REQUEST 8
    #define GAME_DEF_ACTION_MOVE_RESPONSE 9
